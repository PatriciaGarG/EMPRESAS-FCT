  ...
  <div class="w-full h-[100px] flex bg-primary items-center justify-between">
    ...
    >
      <router-link to="/dashboard/alumn">
        <button
          :class="[
            'w-[200px] h-[100px] px-4 text-[19px] cursor-pointer',
            isAlumnActive
      ...
      <router-link to="/"
        ><button
          class="w-[200px] h-[100px] text-black px-4 bg-gray-300 hover:bg-secondary hover:text-black text-[19px] cursor-pointer"
        >
          Cerrar sesión
        </button></router-link
      >
