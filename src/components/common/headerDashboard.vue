...
<template>
  <div class="w-full h-[100px] flex bg-primary items-center justify-between">
    ...
    >
      ...
      <router-link to="/"
        ><button
          class="w-[200px] h-[100px] text-black px-4 bg-red-600 hover:bg-red-700 hover:not-focus:bg-red-500 hover:text-black text-[19px] hover:text-[20px] cursor-pointer"
        >
          Cerrar sesión
        </button></router-link
      >
